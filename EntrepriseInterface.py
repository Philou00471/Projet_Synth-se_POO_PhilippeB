...
class Ui_EntrepriseGestion(object):
    def setupUi(self, EntrepriseGestion):
        ...
        self.textNumeroEmploye = QtWidgets.QLineEdit(self.gbxFichePaie)
        self.textNumeroEmploye.setGeometry(QtCore.QRect(290, 60, 191, 20))
        self.textNumeroEmploye.setObjectName("textNumeroEmploye")
        ...
        self.gbxConnexion.setGeometry(QtCore.QRect(1770, 280, 331, 301))
